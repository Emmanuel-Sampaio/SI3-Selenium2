...
class TestTeste():
  ...
  def test_teste(self):
    ...
    self.driver.find_element(By.NAME, "user.login").send_keys("charles.casimiro")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".withoutFormat > .col-xs-6").click()
    self.driver.find_element(By.LINK_TEXT, "Portal do Docente").click()
    self.driver.find_element(By.CSS_SELECTOR, "#cmAction-49 > .ThemeOfficeMenuItemText").click()
    ...
    self.driver.find_element(By.ID, "form:titulo").send_keys("Clube dos dados ")
    self.driver.find_element(By.CSS_SELECTOR, "table:nth-child(6) tr:nth-child(4) > td").click()
    ...
    self.driver.find_element(By.ID, "form:dataInicio").send_keys("01/09/2023")
    self.driver.find_element(By.ID, "form:dataFim").click()
    self.driver.find_element(By.ID, "form:dataFim").send_keys("10/09/2023")
    ...
    self.driver.find_element(By.ID, "form:publicoAlvo").send_keys("Alunos do departamento de engenharia de teleinformática")
    self.driver.find_element(By.ID, "form:palavrasChave").click()
    self.driver.find_element(By.ID, "form:palavrasChave").send_keys("Dados ; Estatísitica ; Computação")
    self.driver.find_element(By.ID, "form:telefoneAcao").click()
    self.driver.find_element(By.ID, "form:telefoneAcao").send_keys("8540028922")
    self.driver.find_element(By.ID, "form:emailAcao").click()
    self.driver.find_element(By.ID, "form:emailAcao").click()
    self.driver.find_element(By.ID, "form:emailAcao").send_keys("engcom@ufc.br")
    self.driver.find_element(By.ID, "form:publicoEstimado").click()
    self.driver.find_element(By.ID, "form:publicoEstimado").send_keys("50")
    ...
    element = self.driver.find_element(By.ID, "form:buscarCNPJButton")
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, "#mceu_323 .mce-ico")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Texto qualquer<br data-mce-bogus=\"1\"></p>'}", element)
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Texto qualquer<br data-mce-bogus=\"1\"></p>'}", element)
    self.driver.switch_to.default_content()
    self.driver.find_element(By.ID, "elgen-14").click()
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Texto qualquer<br data-mce-bogus=\"1\"></p>'}", element)
    self.driver.switch_to.default_content()
    self.driver.find_element(By.ID, "elgen-22").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#modalidadeEducacao > option:nth-child(3)").click()
    ...
    self.driver.find_element(By.ID, "numeroVagas").send_keys("60")
    self.driver.find_element(By.LINK_TEXT, "Gravar e Avançar >>").click()
    self.driver.find_element(By.ID, "frmobjetivos:objetivo").click()
    self.driver.find_element(By.ID, "frmobjetivos:objetivo").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "frmobjetivos:quantitativos").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "frmobjetivos:qualitativos").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "frmobjetivos:atividades").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "frmobjetivos:dataInicio").send_keys("01/09/2023")
    self.driver.find_element(By.ID, "frmobjetivos:dataFim").send_keys("01/09/2023")
    ...
    element = self.driver.find_element(By.ID, "frmobjetivos:j_id_jsp_720929453_233")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    ...
    self.driver.find_element(By.ID, "equipe:nomeDocente").send_keys("michela mulas")
    self.driver.find_element(By.CSS_SELECTOR, "#\\31 9037 div:nth-child(2)").click()
    self.driver.find_element(By.ID, "equipe:chDedicadaDocente").click()
    self.driver.find_element(By.ID, "equipe:chDedicadaDocente").send_keys("20")
    self.driver.find_element(By.LINK_TEXT, "Adicionar Membro").click()
    self.driver.find_element(By.CSS_SELECTOR, ".formulario:nth-child(5) tr:nth-child(2) > td").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "Adicionar Membro").click()
    self.driver.find_element(By.CSS_SELECTOR, ".formulario:nth-child(5) tr:nth-child(3) > td").click()
    self.driver.find_element(By.ID, "equipe:chDedicadaDocente").click()
    self.driver.find_element(By.ID, "equipe:chDedicadaDocente").send_keys("10")
    self.driver.find_element(By.LINK_TEXT, "Adicionar Membro").click()
    self.driver.find_element(By.ID, "equipe:categoriaMembro").click()
    dropdown = self.driver.find_element(By.ID, "equipe:categoriaMembro")
    dropdown.find_element(By.XPATH, "//option[. = 'Externo']").click()
    self.driver.find_element(By.CSS_SELECTOR, "option:nth-child(5)").click()
    self.driver.find_element(By.ID, "equipe:categoriaMembro").click()
    self.driver.find_element(By.ID, "equipe:categoriaMembro").click()
    dropdown = self.driver.find_element(By.ID, "equipe:categoriaMembro")
    dropdown.find_element(By.XPATH, "//option[. = 'Docente']").click()
    self.driver.find_element(By.CSS_SELECTOR, "#equipe\\3A categoriaMembro > option:nth-child(2)").click()
    self.driver.find_element(By.ID, "equipe:nomeDocente").click()
    ...
    self.driver.find_element(By.ID, "formAnexosAtividade:descricao").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "formAnexosAtividade:uFile").click()
    self.driver.find_element(By.ID, "formAnexosAtividade:uFile").send_keys("C:\\fakepath\\teste.py")
    self.driver.find_element(By.LINK_TEXT, "Gravar e Avançar >>").click()
    self.driver.find_element(By.ID, "formAnexosAtividade:descricao").click()
    self.driver.find_element(By.ID, "formAnexosAtividade:descricao").send_keys("Texto qualquer")
    self.driver.find_element(By.ID, "formAnexosAtividade:uFile").click()
